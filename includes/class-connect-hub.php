...
class Connect_Hub 
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Connect_Hub_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Connect_Hub_Loader. Orchestrates the hooks of the plugin.
	 * - Connect_Hub_i18n. Defines internationalization functionality.
	 * - Connect_Hub_Admin. Defines all hooks for the admin area.
	 * - Connect_Hub_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() 
	{
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-connect-hub-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-connect-hub-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-connect-hub-admin.php';
	 ...
	 *
	 * Uses the Connect_Hub_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
